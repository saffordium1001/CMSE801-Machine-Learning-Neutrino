...
from neutrino import neutrino, data_generator
from neutrino import threadloader

from collections import OrderedDict

thread_io_sparsetensor2d_cfg_template = '''
{name}: {{
  Verbosity:       2
  EnableFilter:    false
  RandomAccess:    0
...
def test_sparsetensor2d_threadio(tmpdir, num_threads, num_storage, make_copy, batch_size, n_projections, n_reads=10):
    ...
    file_name = str(tmpdir + "/test_threadio_sparsetensor2d_{}.h5".format(threadio_name))
    ...
    config_contents = thread_io_sparsetensor2d_cfg_template.format(
        name        = threadio_name,
    ...
    config_file = tmpdir + "/test_threadio_sparsetensor2d_{}.cfg".format(threadio_name)
...
if __name__ == "__main__":
    test_sparsetensor2d_threadio("./", num_threads=1, num_storage=1, make_copy=False, batch_size=2, n_projections=1, n_reads=10)
    test_sparsetensor2d_threadio("./", num_threads=1, num_storage=2, make_copy=False, batch_size=2, n_projections=2, n_reads=10)
    print("Success")
