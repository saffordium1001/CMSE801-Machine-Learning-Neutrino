"""
Computing track lengths through the Earth and density at
...
class PREM(object):
    ...
    def getLayers(self, zenith_in_deg):
        ...
        if zenith_in_deg < zenith_break:
            ...
            if self.verbose:
                print("Zenith %f less than break zenith (%f). The baseline length is %f" %(zenith_in_deg, zenith_break, length))
