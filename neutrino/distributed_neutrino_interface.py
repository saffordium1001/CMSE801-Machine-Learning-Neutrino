...
from threadloader import neutrino_threadio
from neutrino_io_enums import ReadOption
...
class thread_interface(object):
    ...
    def __init__(self,
        ...
        if (self._local_rank is None) and (self._read_option is ReadOption['read_from_single_local_rank']):
            ...
            raise Exception("Please specify local_rank in neutrino_interface constructor.")
        ...
        if (self._local_size is None) and (self._read_option is ReadOption['read_from_single_local_rank']):
            ...
            raise Exception("Please specify local_size in neutrino_interface constructor.")
