...
#ifndef __NEUTRINO_IMPLEMENT_THREADIO_BATCHDATAQUEUE_H
#define __NEUTRINO_IMPLEMENT_THREADIO_BATCHDATAQUEUE_H
...
namespace neutrino_implement {
  ...
  */
  ...
  private:
    neutrino_implement::BatchData<T> _data_current;
    neutrino_implement::BatchData<T> _data_next;
