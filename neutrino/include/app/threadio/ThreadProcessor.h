...
#ifndef __NEUTRINO_IMPLEMENT_THREADIO_THREADPROCESSOR_H
#define __NEUTRINO_IMPLEMENT_THREADIO_THREADPROCESSOR_H

#include "neutrino_implement/core/processor/ProcessDriver.h"
...
namespace neutrino_implement {
  ...
  */
  class ThreadProcessor : public neutrino_base {
  ...
  public:
    ...
    inline const std::vector<neutrino_implement::BatchDataState_t>& storage_status_array() const
    ...
    inline const std::vector<neutrino_implement::ThreadFillerState_t>& thread_status() const
    ...
    const std::vector<neutrino_implement::EventID>& processed_events(size_t storage_id) const;
    ...
    inline const std::vector<neutrino_implement::BatchDataType_t>& batch_types() const
  ...
  private:
    ...
    std::vector<neutrino_implement::BatchDataType_t> _batch_data_type_v;
    ...
    std::vector<neutrino_implement::ProcessDriver*> _driver_v;
    ...
    std::vector<neutrino_implement::BatchDataState_t> _batch_state_v;
    std::vector<std::vector<size_t> > _batch_entries_v;
    std::vector<std::vector<neutrino_implement::EventID> > _batch_events_v;
