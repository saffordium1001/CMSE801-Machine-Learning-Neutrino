...
#ifndef __NEUTRINO_IMPLEMENT_THREADIO_BATCHFILLERTEMPLATE_H__
#define __NEUTRINO_IMPLEMENT_THREADIO_BATCHFILLERTEMPLATE_H__
  ...
  public:
    ...
    inline void batch_end()
    {
      if (!_batch_data_ptr->is_filled()) {
        NEUTRINO_CRITICAL() << "Batch data is not filled @ end-of-batch (" << _batch_data_ptr->current_data_size()
