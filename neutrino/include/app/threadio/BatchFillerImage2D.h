...
#ifndef __NEUTRINO_IMPLEMENT_THREADIO_BATCHFILLERIMAGE2D_H__
#define __NEUTRINO_IMPLEMENT_THREADIO_BATCHFILLERIMAGE2D_H__

#include "neutrino_implement/core/processor/ProcessFactory.h"
#include "BatchFillerTemplate.h"
#include "RandomCropper.h"
#include "neutrino_implement/core/dataformat/EventTensor.h"
namespace neutrino_implement {
  ...
  */
  ...
  /**
     \class neutrino_implement::BatchFillerImage2DFactory
     \brief A concrete factory class for neutrino_implement::BatchFillerImage2D
  */
