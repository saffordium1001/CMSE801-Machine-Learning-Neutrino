...
#ifndef __NEUTRINO_IMPLEMENT_THREADIO_QUEUEPROCESSOR_H
#define __NEUTRINO_IMPLEMENT_THREADIO_QUEUEPROCESSOR_H
...
namespace neutrino_implement {
  ...
  */
  class QueueProcessor : public neutrino_base {
  ...
  public:
    ...
    const std::vector<neutrino_implement::EventID>& processed_events() const;
  ...
  private:
    ...
    neutrino_implement::ProcessDriver _driver;
    ...
    std::vector<neutrino_implement::EventID> _current_batch_events_v;
    std::vector<size_t> _next_batch_entries_v;
    std::vector<neutrino_implement::EventID> _next_batch_events_v;
