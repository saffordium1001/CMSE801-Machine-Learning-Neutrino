...
#ifndef __NEUTRINO_IMPLEMENT_THREADIO_BATCHDATASTORAGE_H
#define __NEUTRINO_IMPLEMENT_THREADIO_BATCHDATASTORAGE_H
...
namespace neutrino_implement {
  ...
  */
  ...
  private:
    std::vector<neutrino_implement::BatchData<T> > _data_v;
  };
