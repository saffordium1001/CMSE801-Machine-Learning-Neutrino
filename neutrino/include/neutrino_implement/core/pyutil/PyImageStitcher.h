...
//     std::vector< std::vector<neutrino_implement::Image2D> > _image_vv;
...
//   /**
//      \class neutrino_implement::PyImageStitcherFactory
//      \brief A concrete factory class for neutrino_implement::PyImageStitcher
//   */
