...
#ifndef __NEUTRINO_IMPLEMENT_DATAFORMAT_EVENTID_H
#define __NEUTRINO_IMPLEMENT_DATAFORMAT_EVENTID_H
  ...
  public:
    static hid_t get_datatype() {
      ...
      status = H5Tinsert (datatype, "run",
                  HOFFSET (EventID, _run), neutrino_implement::get_datatype<long>());
      status = H5Tinsert (datatype, "subrun",
                  HOFFSET (EventID, _subrun), neutrino_implement::get_datatype<long>());
      status = H5Tinsert (datatype, "event",
                  HOFFSET (EventID, _event), neutrino_implement::get_datatype<long>());
      return datatype;
    }
#endif
