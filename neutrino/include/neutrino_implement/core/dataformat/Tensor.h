...
#ifndef __NEUTRINO_IMPLEMENT_DATAFORMAT_TENSOR_H__
#define __NEUTRINO_IMPLEMENT_DATAFORMAT_TENSOR_H__
...
namespace neutrino_implement {
  ...
  */
  ...
  public:
    ...
    /// Reset contents w/ new neutrino_implement::ImageMeta
    ...
    /// neutrino_implement::ImageMeta const reference getter
    ...
    // /// Crop specified region via crop_meta to generate a new neutrino_implement::Image2D
    ...
    Tensor& operator -=(const std::vector<float>& rhs);
    Tensor& operator +=(const neutrino_implement::Tensor<dimension>& rhs);
    ...
    // The following functions were deprecated for neutrino_implement3.
