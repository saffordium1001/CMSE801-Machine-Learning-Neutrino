#ifndef __NEUTRINO_IMPLEMENT_DATAFORMAT_DATAFORMATTYPES_H__
#define __NEUTRINO_IMPLEMENT_DATAFORMAT_DATAFORMATTYPES_H__
...
namespace neutrino_implement {
  ...
  typedef std::set<neutrino_implement::MCTrackID_t> MCTrackIDSet_t;

  /// ProducerID_t to identify a unique data product within a process (for neutrino_implement::IOManager)
  typedef size_t ProducerID_t;
  /// ProductName_t to identify a unique data product within a process (for neutrino_implement::IOManager)
  ...
  // datatypes used in neutrino_implement to datatypes needed for hdf5 serialization.
