...
#ifndef __NEUTRINO_IMPLEMENT_DATAFORMAT_IMAGEMETA_H__
#define __NEUTRINO_IMPLEMENT_DATAFORMAT_IMAGEMETA_H__
 ...
 public:
  ...
  public:
    static hid_t get_datatype() {
      ...
      hid_t double_type = H5Tarray_create(neutrino_implement::get_datatype<double>(), 1, array_dimensions);
      hid_t size_t_type = H5Tarray_create(neutrino_implement::get_datatype<size_t>(), 1, array_dimensions);

      status = H5Tinsert (datatype, "valid",
                  HOFFSET (ImageMeta, _valid),            neutrino_implement::get_datatype<bool>());
      status = H5Tinsert (datatype, "projection_id",
                  HOFFSET (ImageMeta, _projection_id),    neutrino_implement::get_datatype<size_t>());
