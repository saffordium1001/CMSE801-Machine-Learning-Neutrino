...
#ifndef __NEUTRINO_IMPLEMENT_BASE_TYPES_H__
#define __NEUTRINO_IMPLEMENT_BASE_TYPES_H__
...
namespace neutrino_implement {
  ...
  /// Namespace for neutrino_implement message related types
  namespace msg {
